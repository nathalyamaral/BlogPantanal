...
<head>
		<title>Pantanal &mdash; Blog</title>
		<meta charset="utf-8">
				...
				<div class="container">
					<div class="collapse navbar-collapse" id="navbarMenu">
						<ul class="navbar-nav mx-auto">
							...
							<li class="nav-item">
								<a class="nav-link" style="color: #00AF86;" href="{{route('login')}}"> Login </button></a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="container-fluid">
							<div class="row">
								@foreach($posts_cat as $postc)
									<div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
										<img src="{{$postc->image_slug}}" alt="">
										<div class="portfolio_images_overlay text-center">
											<p class="clrd-font">{{$postc->title}}</p>
											<a style="font-size: 80%" href="/blogsingle{{$postc->id}}" class="btn btn-primary">Ver post</a>
										</div>
									</div>
								@endforeach
							</div>
				...
				<div class="row blog-entries">
					<div class="col-md-12 col-lg-8 main-content">
						<div class="row">
							@foreach($posts as $post)
								<div class="col-md-6">
									<a href="/blogsingle{{$post->id}}"  class="blog-entry element-animate" data-animate-effect="fadeIn">
									<img src="{{$post->image_slug}}" width="100%" height="230px" alt="Image placeholder">
									<div class="blog-content-body">
										<div class="post-meta">
										<span class="author mr-2"><img src="images/person_1.jpg" alt="Colorlib"> 
											{{$post->user->name}}</span>&bullet;
					...
					<div class="col-md-12 col-lg-4 sidebar">
						...
						<div class="sidebar-box">
							<h3 class="heading">Anuncios</h3>
							<div class="post-entry-sidebar">
								<ul>
									<a href="https://mcdonalds.com.br" target="_blank">
										<li>
										<img src="images/mc.jpg" alt="Image placeholder" width="100%"> 
										</li>
									</a>
									<a href="https://cinemark.com.br" target="_blank">
									<li>
										<img src="images/cine.jpg" alt="Image placeholder" width="100%">
									</li>
									</a>
								</ul>
							</div>
							...
							<div class="col-md-7">
								...
								<div class="post-entry-sidebar">
									<ul>
										...
										<li>
											<a href="">
												<img src="images/mc.jpg" alt="Image placeholder" class="mr-4">
												<div class="text">
													<h4>How to Find the Video Games of Your Youth</h4>
													<div class="post-meta">
														<span class="mr-2">March 15, 2018 </span> &bullet;
