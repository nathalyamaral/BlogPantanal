...
<div id="animate">
    ...
    <div class="text-center">
        <img src="{{asset('admin/assets/img/404.png')}}" class="img-fluid center-block" alt="Page Not Found"/>
    </div>
</div>
<!-- global js -->
<!--jQuery 2.1.1 -->
...
<script type="text/javascript" src="{{asset('admin/assets/js/pages/404.js')}}"></script>
