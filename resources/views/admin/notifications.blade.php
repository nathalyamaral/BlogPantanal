...
@section('header_styles')
    ...
    <!--page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/toastr.css')}}" />
                ...
                <div class="col-sm-6 col-lg-6">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align notifications_text_hover">
                        <li class="breadcrumb-item">
                            <a href="index" class="breadcrumb-item-color">
                                <i class="fa fa-home" data-pack="default" data-tags=""></i>
                                Dashboard
                            </a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#" class="breadcrumb-item-color">Components</a>
                        </li>
        ...
        <div class="inner row bg-container">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block basic_notifications">
                        <div id="layouts">
                            <div class="row">
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/noty/js/jquery.noty.packaged.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('admin/assets/vendors/toastr/js/toastr.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/toastr_notifications.js')}}"></script>
