...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/hover/css/hover-min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/wow/css/animate.css')}}"/>
    <!-- end of plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/animations.css')}}"/>
    ...
    <div class="outer">
        <div class="inner bg-container">
            <div class="row animations_page">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block bling_buttons">
                            <div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-t-35">
                        ...
                        <div class="card-block wow_animation">
                            <div class="row">
...
@section('footer_scripts')
    <!--plugin script-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/snabbt/js/snabbt.min.js')}}"></script>
