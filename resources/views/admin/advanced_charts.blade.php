...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/advanced_charts.css')}}"/>
...
<script type="text/javascript" src="{{asset('admin/assets/vendors/justgage/js/justgage.js')}}"></script>
...
<script type="text/javascript" src="{{asset('admin/assets/js/pages/advanced_charts.js')}}"></script>
