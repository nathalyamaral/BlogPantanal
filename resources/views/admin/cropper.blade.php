...
@section('header_styles')
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/cropper/css/cropper.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/cropper.css')}}" />
...
@section('content')
    ...
    <div class="outer">
        <div class="inner bg-container">
            <div class="row">
                <div class="col-lg-12">
                    <img id="image" src="{{asset('admin/assets/img/crop.png')}}" alt="not found">
            ...
            <div class="row">
                <div class="col-md-12 docs-buttons m-t-35">
                    ...
                    <div class="btn-group btn-group-crop">
                        <button type="button" class="btn btn-primary" data-method="getCroppedCanvas">Save
                            Image
                        </button>
...
@section('footer_scripts')
    <!--plugin script-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/cropper/js/cropper.min.js')}}"></script>
    <!-- end of plugin scripts -->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/cropper.js')}}"></script>
@stop