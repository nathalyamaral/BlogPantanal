...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/swiper/css/swiper.min.css')}}"/>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-7">
                    <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item active">Widgets2</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white section_border">
                            ...
                            <div class="swiper-container men_shoes_swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoesm1.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoesm2.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoesm3.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                        ...
                        <div class="header_align">
                            ...
                            <div class="swiper-container women_shoes_swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoes.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoes2.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('admin/assets/img/shoes3.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                </div>
                                <div class="swiper-pagination"></div>
                            </div>
                ...
                <div class="col-lg-4 col-12 m-t-35">
                    <div class="card">
                        ...
                        <div class="card-block m-t-35">
                            <div class="row">
                                <div class="col-4">
                                    <img src="{{asset('admin/assets/img/images.jpg')}}" alt="admin" class="rounded-circle img-fluid">
                                </div>
                                ...
                                <div class="col-4">
                                    <img src="{{asset('admin/assets/img/authors/avatar7.jpg')}}" alt="admin" class="rounded-circle img-fluid avatar_rounded">
                                </div>
                            </div>
                            <div>
                                <div class="row m-t-5">
                    ...
                    <div class="bg-white section_border">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12 m-t-5">
                                <form action="{{URL::to('widgets2')}}" id="widgets_login_validator"  class="login_validator header_align">
                            ...
                            <div class="weather_img">
                                <div class="row header_align">
                                    ...
                                    <div class="icon col-5 col-sm-4">
                                        <img src="{{asset('admin/assets/img/weather1.png')}}" alt="weather" class="img-fluid">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="row header_align">
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="{{asset('admin/assets/img/w5.png')}}" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="{{asset('admin/assets/img/w2.png')}}" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="{{asset('admin/assets/img/w3.png')}}" alt="weather" class="img-fluid">
                                                        </div>
                                                ...
                                                <div class="col-2 border_right days_margin_top">
                                                    <div class="day text-center">
                                                        ...
                                                        <div>
                                                            <img src="{{asset('admin/assets/img/w4.png')}}" alt="weather" class="img-fluid">
                                                        </div>
                            ...
                            <div class="col-lg-12 col-12">
                                <div class="row">
                                    <div class="col-3 float-left">
                                        <img src="{{asset('admin/assets/img/authors/avatar1.jpg')}}" alt="Image missing" class="rounded-circle" height="50" width="50"/>
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/circliful/js/jquery.circliful.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/swiper/js/swiper.min.js')}}"></script>
