            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="{{route('admin.form-add-user')}} " id="editable_table_new" class=" btn btn-default">
                                            ...
                                            <tr role="row" class="even">
                                                ...
                                                <td>
                                                    <div class="row examples"> 
                                                        <a href="{{route('admin.profileshow', [$user->id])}}" data-toggle="tooltip" data-placement="top" title="View User"><i class="fa fa-eye text-success m-l-10"></i></a>&nbsp; &nbsp;
                                                        <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" href="{{route('admin.form-edit-user', ['id' => $user->id])}}"><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;
                                                        @if(Auth::user()->id != $user->id)
                                                        <a class="delete hidden-xs hidden-sm delete-user" data-toggle="tooltip" data-animation="false" data-placement="top" title="Delete" data-id="{{ $user->id }}" data-token="{{csrf_token()}}" href="#"><i class="fa fa-trash text-danger"></i></a>
                                                        @endif
                                                    </div> 
                                                </td>
