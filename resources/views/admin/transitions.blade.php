...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/pages/transitions.css')}}" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card parent_card">
                        <div class="card-block animations_parent_card">
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/Knob/js/jquery.knob.js')}}"></script>
    <!-- end of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/transitions-sliders.js')}}"></script>
