    ...
    <div class="inner bg-container">
        <div class="card">
            ...
            <div class="card-block m-t-35">
                ...
                <form method="POST" class="form-horizontal" id="tryitForm" action={{route('admin.store')}}>
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" class="form-control" type="text" name="image_slug" readonly>
                                    </div>
                                    <img class="rounded mx-auto d-block" id="holder" style="margin-top:15px;max-height:100px;">
                                </div>
                            </div>
                            <div class="form-group row m-t-25">
                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <input name='title' type="text" id="subject2" class="form-control" placeholder="Subject">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-3 text-lg-right">
                                    <label for="email" class="col-form-label">Visível *
                                    </label>
                                </div>
                                <div class="col-xl-6 col-lg-8">
                                    <div class="input-group">
                                        <select name='view_role_id' class="form-control">
                                            <option value="">Selecione quem pode ver este post...</option>
                                            @forelse ($roles as $role)
                                                @if($role->name=='assinante')
                                                <option value={{$role->id}}>Somente usuários assinantes</option>
                                                @endif
                                            @empty
                                            <option>Nenhuma categoria disponível</option>
                                            @endforelse
                                ...
                                <div class="col-12">
                                    <div class="card m-t-30 tinymce_full">
                                        <div class="card-header bg-white">
                                            ...
                                            @if ($errors->has('body'))
                                            <small class="has-error" style="">{{ $errors->first('body') }}</small>
                                            @endif
                                        </div>
                                        <div>
                                            <textarea name="body" rows="20" class="form-control my-editor"></textarea>
                                        </div>
                                    </div>
                                </div>
                        </div>
