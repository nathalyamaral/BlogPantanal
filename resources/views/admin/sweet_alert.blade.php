                        ...
                        <div class="card-block m-t-35">
                                ...
                                <div class="col-lg-12">
                                    <div class="row examples">
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-primary source message"> Basic message</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-primary source primary_clr m-l-5">Primary</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-info source info_clr m-l-5">Info</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-warning source warning_clr m-l-5">Warning</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-success source success_clr m-l-5">Success</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-danger source danger_clr m-l-5">Danger</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 m-t-35">
                                    ...
                                    <div class="row examples">
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-gray source ajax-request">Ajax Request</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                            ...
                            <div class="row">
                                <div class="col-lg-12 m-t-35">
                                    ...
                                    <div class="row examples">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-info source jqueryhtml m-l-5">JQuery HTML</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 m-t-35">
                                    ...
                                    <div class="row examples">
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-warning source title-text">Title with a text under</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-success source success m-l-5">Success message</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-mint source timer m-l-5">Autoclose timer</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-danger source showcase sweet m-l-5">Error message</button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6 m-t-10">
                                            <button class="btn btn-primary source html_ex m-l-5">HTML message</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
