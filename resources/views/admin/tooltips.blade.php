...
@section('header_styles')
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/tooltipster/css/tooltipster.bundle.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/tipso/css/tipso.min.css')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-block m-t-20 text-center text-sm-left">
                                    <div class="row">
                                        <div class="col-lg-12 m-t-15">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <button type="button" class="btn btn-primary m-t-20" data-toggle="tooltip" data-trigger="click" data-placement="left" title="Left">
                                                        Tooltip on left
                                                    </button>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="{{asset('admin/assets/vendors/tooltipster/js/tooltipster.bundle.min.js')}}"></script>
<script type="text/javascript" src="{{asset('admin/assets/vendors/tipso/js/tipso.min.js')}}"></script>
<script type="text/javascript" src="{{asset('admin/assets/js/pages/tooltips.js')}}"></script>
@stop