...
@section('header_styles')
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/themify/css/themify-icons.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/vendors/ionicons/css/ionicons.min.css')}}" />

    <!--page level styles-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/pages/icon.css')}}" />
...
@section('footer_scripts')
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/icons.js')}}"></script>
