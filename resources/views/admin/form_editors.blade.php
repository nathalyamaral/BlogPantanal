...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/summernote/js/summernote.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/form_editors.js')}}"></script>
