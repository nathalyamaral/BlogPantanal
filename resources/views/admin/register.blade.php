                ...
                <div class="col-lg-6 push-lg-3 col-sm-10 push-sm-1">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-xs-center">
                            <img src="{{asset('admin/assets/img/logow.png')}}" alt="josh logo" class="admire_logo"><span class="text-white"> ADMIRE<br/>
                                Sign Up</span>
                        </h3>
                    </div>
                    <div class="bg-white login_content login_border_radius">
                        <form class="form-horizontal login_validator m-b-20" id="register_valid"
                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    <label class="form-control-label">Already have an account?</label> <a href="login " class="text-primary login_hover"><b>Log In</b></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<!--End of plugin js-->
<!--Page level js-->
<script type="text/javascript" src="{{asset('admin/assets/js/pages/register.js')}}"></script>
