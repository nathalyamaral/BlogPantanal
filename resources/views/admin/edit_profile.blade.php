        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    ...
                    <form enctype="multipart/form-data" method="POST" class="form-horizontal login_validator" id="tryitForm" action={{route('admin.updateProfile')}}>
                        {{ method_field('PUT') }}
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <input type="text" name="name" value="{{$user->name}}" id="u-name"
                                                       class="form-control">
                                            </div>
