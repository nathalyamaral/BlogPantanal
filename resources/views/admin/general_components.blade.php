...
@section('header_styles')
    <!--page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/general_components.css')}}"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card m-t-35">
                                        <div class="card-header card-primary text-white">Card Primary</div>
                                        <div class="card-block">
                                            <p>
                                                Lorem Ipsum is simply dummy text of the printing and typesetting
                                ...
                                <div class="col-lg-4">
                                    <div class="card m-t-35">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <img src="{{asset('admin/assets/img/gallery/full/8.jpg')}}" class="img-fluid"
                                                 alt="Photo of sunset">
                                        </div>
                            ...
                            <div class="list-group m-t-35">
                                <ul class="list-group lists_margin_bottom">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <span class="badge badge-pill badge-primary float-right">44</span>
                                    </li>
                ...
                <div class="col-lg-6 m-t-35">
                    <div class="card">
                        ...
                        <div class="card-block progress_bars_margin_top">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress">
