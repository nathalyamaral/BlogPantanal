...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/radio_css/css/radiobox.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/checkbox_css/css/checkbox.min.css')}}" />
    <!--End of Plugin styles-->
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/radio_checkbox.css')}}"/>
...
@section('footer_scripts')
    ...
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/radio_checkbox.js')}}"></script>
