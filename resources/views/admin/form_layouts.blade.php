...
@section('header_styles')
    <!--plugin styles-->
    <link rel="stylesheet" href="{{asset('admin/assets/vendors/intl-tel-input/css/intlTelInput.css')}}">
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/form_layouts.css')}}" />
                            ...
                            <form class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-10 push-lg-1 user_icon_change1">
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/intl-tel-input/js/intlTelInput.js')}}"></script>
