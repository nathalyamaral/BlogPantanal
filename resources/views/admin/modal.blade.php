...
@section('header_styles')
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/modal/css/component.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/bootstrap-tagsinput/css/bootstrap-tagsinput.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/vendors/animate/css/animate.min.css')}}" />
    <!--page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/portlet.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/advanced_components.css')}}"/>
...
@section('footer_scripts')
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/modals.js')}}"></script>
