        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-block m-t-35">
                    ...
                    <form enctype="multipart/form-data" method="POST" class="form-horizontal login_validator" id="tryitForm" action={{route('admin.userStore')}}>
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-xl-6 col-lg-8">
                                                    <div class="input-group">
                                                            <textarea id="text4" name="biography" class="form-control" cols="50" rows="5" maxlength="300"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                    <div class="form-group row">
