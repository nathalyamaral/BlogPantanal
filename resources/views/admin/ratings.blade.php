...
@section('header_styles')
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/starability/css/starability-all.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/bootstraprating/css/star-rating.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/rateyo/css/jquery.rateyo.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/sweetalert/css/sweetalert2.min.css')}}" />
    <!--End of Plugin styles-->
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/ratings.css')}}"/>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="row m-t-30">
                                <div class="col-12 col-lg-6 col-sm-6 m-t-5">
                                    <form>
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/bootstraprating/js/star-rating.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('admin/assets/vendors/rateyo/js/jquery.rateyo.js')}}"></script>
    <script type="text/javascript" src="{{asset('admin/assets/vendors/sweetalert/js/sweetalert2.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/ratings.js')}}"></script>
