...
@section('header_styles')
    <!--Plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/bootstrap3-wysihtml5-bower/css/bootstrap3-wysihtml5.min.css')}}"/>
    <!--page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/mail_box.css')}}"/>
            ...
            <div class="row web-mail mail_compose">
                    ...
                    <div>
                        <ul class="list-group">
                            <li class="list-group-item bg-success">
                                <a href="{{ route('admin.compose') }}" class="mail_inbox_text_col">
                                    <i class="fa fa-edit"></i>
                                    Compose
                                </a>
                            </li>
                        ...
                        <ul class="list-group contact_scroll">
                            <li class="list-group-item status_height">
                                <a href="#">
                                    ...
                                    <span class="float-left">
                                            <img src="{{asset('admin/assets/img/mailbox_imgs/1.jpg')}}"
                            ...
                            <li class="list-group-item status_height">
                                <a href="#">
                                    ...
                                    &nbsp; Marin Robbinson
                                    <span class="float-left">
                                            <img src="{{asset('admin/assets/img/mailbox_imgs/3.jpg')}}"
                            ...
                            <li class="list-group-item status_height">
                                <a href="#">
                                    ...
                                    &nbsp; Kimy Zorda
                                    <span class="float-left">
                                            <img src="{{asset('admin/assets/img/mailbox_imgs/4.jpg')}}"
                                                 class="rounded-circle img-responsive float-left inbox_contact_img" alt="Image"></span>
                                </a>
                            </li>
                            <li class="list-group-item status_height">
                            ...
                            <li class="list-group-item status_height">
                                <a href="#">
                                    ...
                                    &nbsp; David Miller
                                    <span class="float-left">
                                            <img src="{{asset('admin/assets/img/mailbox_imgs/7.jpg')}}"
                                                 class="rounded-circle img-responsive float-left inbox_contact_img" alt="Image"></span>
                                </a>
                            </li>
                            <li class="list-group-item status_height">
                ...
                <div class="col-lg-9">
                    <div class="card media_max_991">
                        ...
                        <form method="POST" action="{{ route('admin.enviar') }}">
                                @csrf
                                <div class="form-group">
                                    <input name='email' type="email" class="form-control" placeholder="To *" required>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 m-t-10">
                                            <input type="email" class="form-control" placeholder="Cco">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input name="assunto" type="text" class="form-control m-t-25" placeholder="Assunto *" required>
                                </div>
                                <div class="form-group mail_compose_wysi">
                                    <textarea name="body" class="wysihtml5 form-control m-t-20"></textarea>
                                </div>
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/vendors/bootstrap3-wysihtml5-bower/js/bootstrap3-wysihtml5.all.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/mail_box.js')}}"></script>
