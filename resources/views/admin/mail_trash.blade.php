                ...
                <div class="col-lg-3 mail_compose_list">
                    <div>
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <a href="mail_spam">
                                    <span class="tag tag-primary tag-pill float-right">14</span>
                            ...
                            <li class="list-group-item">
                                <a href="mail_draft">
                                    <span class="tag tag-primary tag-pill float-right">16</span>
                            ...
                            <li class="list-group-item bg-success">
                                <a href="mail_trash" class="mail_inbox_text_col">
                                    <span class="tag tag-warning tag-pill float-right">16</span>
                                    <i class="fa fa-trash"></i>
                                    Trash
                                </a>
                            </li>
                            ...
                            <li class="list-group-item starred_mail">
                                <a href="#">
                                    <span class="tag tag-primary tag-pill float-right">3</span>
                            ...
                            <li class="list-group-item starred_mail">
                                <a href="#">
                                    <span class="tag tag-pill tag-primary float-right">14</span>
                            ...
                            <li class="list-group-item starred_mail">
                                <a href="#">
                                    <span class="tag tag-primary tag-pill float-right">26</span>
                            ...
                            <li class="list-group-item starred_mail">
                                <a href="#">
                                    <span class="tag tag-primary tag-pill float-right">36</span>
...
@section('footer_scripts')
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/mail_sent.js')}}"></script>
