...
@section('header_styles')
    <!--Plugin styles -->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/jstree/css/style.min.css')}}"/>
    <!--Page level styles-->
@stop
    @section('content')
        <header class="head">
...
<script type="text/javascript" src="{{asset('admin/assets/vendors/jstree/js/jstree.min.js')}}"></script>
<script type="text/javascript" src="{{asset('admin/assets/js/pages/jstree.js')}}"></script>
@stop