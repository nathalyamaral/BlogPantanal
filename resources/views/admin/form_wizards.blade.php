...
@section('header_styles')
    ...
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/wizards.css')}}"/>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/twitter-bootstrap-wizard/js/jquery.bootstrap.wizard.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/wizard.js')}}"></script>
