...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/datatables/css/scroller.bootstrap.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/datatables/css/colReorder.bootstrap.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/vendors/datatables/css/dataTables.bootstrap.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/dataTables.bootstrap.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/responsive.dataTables.css')}}" />
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('admin/assets/js/pluginjs/dataTables.tableTools.js')}}"></script>
    <script type="text/javascript" src="{{asset('admin/assets/vendors/datatables/js/dataTables.colReorder.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/datatables/js/dataTables.rowReorder.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/datatables/js/dataTables.scroller.min.js')}}"></script>
    <!-- end of plugin scripts -->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/datatable.js')}}"></script>
