...
@section('header_styles')
    <!--Page level styles-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/pages/flot_charts.css')}}">
...
@section('footer_scripts')
    ...
    <!--plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/flot_charts.js')}}"></script>
