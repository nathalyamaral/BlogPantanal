                        ...
                        <div class="card-block m-t-35">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-sm-4 col-6 m-t-20">
                                    <img class="img-thumbnail img-fluid view_admin_img" alt="Admin" src="{{asset('admin/assets/img/mailbox_imgs/1.jpg')}}">
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-4 col-6  m-t-20">
                                    <img class="img-thumbnail img-fluid view_admin_img" alt="Admin" src="{{asset('admin/assets/img/mailbox_imgs/3.jpg')}}">
                                </div>
                            </div>
                            <br/>
                            <hr>
