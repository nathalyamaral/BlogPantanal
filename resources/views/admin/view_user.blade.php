...
@section('header_styles')
    ...
    <!--End off plugin css-->
    <!--Page level css-->
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/timeline2.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/calendar_custom.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/css/pages/profile.css')}}"/>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div class="btn_file_position">
                                                    <span class="btn btn-primary btn-file">
                                                        ...
                                                        <input type="file" accept="image/png, image/jpeg, image/gif" name="Changefile">
                                                    </span>
                                    ...
                                    <div class="view_friends_imgs"><br/>
                                        ...
                                        <div class="friends_img_left">
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/2.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/3.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/5.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/6.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/7.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/8.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                            <div class="thumb_zoom zoom">
                                                <img src="{{asset('admin/assets/img/mailbox_imgs/10.jpg')}}" class="img-rounded" alt="friend">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card_nav_body_padding follower_images">
                                            <div class="row">
                                                <div class="col-sm-3 col-xl-2">
                                                    <div class="img">
                                                        <a href="#">
                                                            <img src="{{asset('admin/assets/img/mailbox_imgs/2.jpg')}}" class="rounded-circle" alt="friend">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row m-t-15">
                                                <div class="col-sm-3 col-xl-2">
                                                    <div class="img">
                                                        <a href="#">
                                                            <img src="{{asset('admin/assets/img/mailbox_imgs/3.jpg')}}" class="rounded-circle" alt="friend">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row m-t-15">
                                                <div class="col-xl-2 col-sm-3">
                                                    <div class="img">
                                                        <a href="#">
                                                            <img src="{{asset('admin/assets/img/mailbox_imgs/8.jpg')}}" class="rounded-circle" alt="friend">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row m-t-15">
                                                <div class="col-xl-2 col-sm-3">
                                                    <div class="img">
                                                        <a href="#">
                                                            <img src="{{asset('admin/assets/img/mailbox_imgs/6.jpg')}}" class="rounded-circle" alt="friend">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-xl-10 col-sm-9">
                                            ...
                                            <div class="row m-t-15">
                                                <div class="col-xl-2 col-sm-3">
                                                    <div class="img">
                                                        <a href="#">
                                                            <img src="{{asset('admin/assets/img/mailbox_imgs/5.jpg')}}" class="rounded-circle" alt="friend">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-xl-10 col-sm-9">
                        ...
                        <div class="card-block m-t-35 padding">
                            <div class="feed">
                                <ul>
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/roundicons/flat/Office-27.png')}}" alt="text_image"
                                    ...
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/roundicons/flat/Technology-07.png')}}"
                                                             alt="text_image"
                                                             class="rounded-circle img-fluid recent_feeds_img"/>
                                                    </span>
                                        <h5>
                                    ...
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/mailbox_imgs/8.jpg')}}"
                                    ...
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/mailbox_imgs/6.jpg')}}"
                                                             class="rounded-circle img-fluid pull-left recent_feeds_img"
                                                             alt="Image">
                                                    </span>
                                        <h5>
                                    ...
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/roundicons/flat/Office-06.png')}}" alt="text_image"
                                                             class="rounded-circle img-fluid recent_feeds_img"/>
                                                    </span>
                                        <h5>
                                            Notice
                                    ...
                                    <li>
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/mailbox_imgs/5.jpg')}}"
                                                             class="rounded-circle img-fluid pull-left recent_feeds_img"
                                                             alt="Image">
                                                    </span>
                                        <h5>
                                    ...
                                    <li class="no-border">
                                                    <span>
                                                        <img src="{{asset('admin/assets/img/mailbox_imgs/2.jpg')}}"
                                                             class="rounded-circle img-fluid pull-left recent_feeds_img"
                                                             alt="Image">
                                                    </span>
                                        <h5>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('admin/assets/vendors/bootstrap_calendar/js/bootstrap_calendar.min.js')}}"></script>
    ...
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('admin/assets/js/pages/mini_calendar.js')}}"></script>
